...
from app.core.config import NAMESPACE, v1_api, DATA_OBSERVER_URL, HARBOR_SECRET_NAME, SHARED_PVC_NAME
    ...
    pod_manifest = {
        ...
        "spec": {
            ...
            "volumes": [
                ...
                {"name": "shared-volume", "persistentVolumeClaim": {"claimName": SHARED_PVC_NAME}}
            ],
            "restartPolicy": "Never"
        }
    }
